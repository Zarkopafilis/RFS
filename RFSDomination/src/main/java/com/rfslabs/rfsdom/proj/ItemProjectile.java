...
import net.minecraft.server.v1_7_R3.IProjectile;
...
import com.rfslabs.rfsdom.proj.TypedRunnable;
import com.rfslabs.rfsdom.proj.CustomProjectileHitEvent;
import com.rfslabs.rfsdom.proj.ItemProjectileHitEvent;
...
public class ItemProjectile extends EntityItem implements IProjectile, CustomProjectile {
    ...
    public ItemProjectile(String name, Location loc, org.bukkit.inventory.ItemStack itemstack, LivingEntity shooter, float power) {
        ...
        else setItemStack(new net.minecraft.server.v1_7_R3.ItemStack(Item.d(itemstack.getTypeId()), itemstack.getAmount(), itemstack.getData().getData()));
    ...
    public ItemProjectile(String name, LivingEntity shooter, org.bukkit.inventory.ItemStack item, float power) {
        ...
        this.shooter = ((CraftLivingEntity) shooter).getHandle();
        this.a(0.25F, 0.25F);
        setPositionRotation(shooter.getLocation().getX(), shooter.getLocation().getY() + 1.7, shooter.getLocation().getZ(), shooter.getLocation().getYaw(), shooter.getLocation().getPitch());
        locX -= (MathHelper.cos(yaw / 180.0F * 3.1415927F) * 0.16F);
        locY -= 0.10000000149011612D;
        locZ -= (MathHelper.sin(yaw / 180.0F * 3.1415927F) * 0.16F);
        setPosition(locX, locY, locZ);
    ...
    public void h() {
        ...
        if ((flag) || (this.ticksLived % 25 == 0)) {
            if (this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.locY), MathHelper.floor(this.locZ)) == net.minecraft.server.v1_7_R3.Block.b("lava")) {
    ...
    @Override
    public net.minecraft.server.v1_7_R3.ItemStack getItemStack() {
        net.minecraft.server.v1_7_R3.ItemStack itemstack = getDataWatcher().getItemStack(10);
        
        if (itemstack == null) { return new net.minecraft.server.v1_7_R3.ItemStack(Blocks.STONE); }
        return itemstack;
    }
